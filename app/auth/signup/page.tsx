...
import { Sparkles, Eye, EyeOff, Mail, Lock, CheckCircle, XCircle, ShieldCheck, Users, Heart } from 'lucide-react';
...
export default function SignUpPage() {
  ...
  const isFormValid = () => {
    return email && !emailError && passwordRequirements.every(req => req.test(password));
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      if (result.error) {
        ...
        // Success! Build excitement for what's coming
        setSuccessMessage(result.message || 'Welcome to the fragrance discovery community!');
      }
    });
  };

  // Success state with celebration and clear next steps
  if (successMessage) {
    return (
          ...
          <Card className="card-elevated border-0 shadow-strong">
            <CardContent className="pt-8 pb-8 text-center">
              <div className="space-y-6">
                ...
                {/* Success headline with luxury feel */}
        ...
        <Card className="card-elevated border-0 shadow-strong">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription className="text-base leading-relaxed">
              Join the AI-powered fragrance discovery platform that finds scents you'll actually love
            </CardDescription>
          </CardHeader>
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      ...
                      email && !emailError ? "border-green-500 focus-visible:ring-green-500/20" : ""
                    )}
            ...
            <div className="space-y-4 pt-4 border-t border-border/40">
              <div className="text-xs text-center text-muted-foreground space-y-2">
                <p>
                  ...
                  <Link href="/terms" className="text-plum-600 hover:text-plum-700 underline">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-plum-600 hover:text-plum-700 underline">
                    Privacy Policy
                  </Link>
                </p>
