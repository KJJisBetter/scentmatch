                  ...
                  <div className="h-full w-full rounded-2xl lg:rounded-3xl bg-gradient-to-br from-plum-50 to-cream-50 flex items-center justify-center p-6">
                    <div className="text-center space-y-3 lg:space-y-4">
                      ...
                      <div className="space-y-1 lg:space-y-2">
                        <p className="font-medium text-plum-900 text-sm lg:text-base">Sample Discovery</p>
                        <p className="text-xs lg:text-sm text-plum-600">Try before you buy</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="container">
          <div className="text-center space-y-4 mb-12 lg:mb-16">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto">
              We're revolutionizing fragrance discovery with AI-powered personalization, affordable sampling, and expert guidance.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <Card className="card-interactive text-center">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg lg:text-xl">AI-Powered Personalization</CardTitle>
                <CardDescription className="text-sm lg:text-base">
                  Unlike generic recommendations, our AI learns your unique preferences to suggest fragrances you'll actually love.
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="card-interactive text-center">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg lg:text-xl">Sample-First Discovery</CardTitle>
                <CardDescription className="text-sm lg:text-base">
                  Try affordable samples and travel sizes before committing to full bottles. Perfect for beginners and budget-conscious buyers.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="text-xs sm:text-sm text-muted-foreground space-y-2 text-left">
            ...
            <Card className="card-interactive text-center sm:col-span-2 lg:col-span-1">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg lg:text-xl">Interactive Testing</CardTitle>
                <CardDescription className="text-sm lg:text-base">
                  Guided blind testing experiences help you discover your true preferences without visual bias or marketing influence.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="text-xs sm:text-sm text-muted-foreground space-y-2 text-left">
        ...
        <div className="container">
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 items-center">
            <div className="space-y-6 text-center lg:text-left">
              <h3 className="font-serif text-xl sm:text-2xl font-bold">Trusted by Fragrance Lovers Everywhere</h3>
              <div className="space-y-4">
                <div className="flex items-center space-x-3 justify-center lg:justify-start">
                  <ShieldCheck className="h-5 w-5 sm:h-6 sm:w-6 text-plum-600 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-sm sm:text-base">Authentic Reviews</p>
                    <p className="text-xs sm:text-sm text-muted-foreground">Verified purchases and experiences</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 justify-center lg:justify-start">
                  <Users className="h-5 w-5 sm:h-6 sm:w-6 text-gold-600 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-sm sm:text-base">Expert Curation</p>
                    <p className="text-xs sm:text-sm text-muted-foreground">Fragrance professionals and enthusiasts</p>
                  </div>
                </div>
                <div className="flex items-center space-x-3 justify-center lg:justify-start">
                  <Star className="h-5 w-5 sm:h-6 sm:w-6 text-cream-600 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-sm sm:text-base">Quality Guarantee</p>
                    <p className="text-xs sm:text-sm text-muted-foreground">100% authentic fragrances</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-2 grid sm:grid-cols-2 gap-4 lg:gap-6">
              <Card className="card-elevated">
                <CardContent className="pt-4 lg:pt-6">
                  <div className="flex items-center space-x-1 mb-2">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="h-3 w-3 sm:h-4 sm:w-4 fill-gold-400 text-gold-400" />
                    ))}
                  </div>
                  <p className="text-xs sm:text-sm italic mb-3 lg:mb-4">
                    "Finally found my signature scent after trying 3 samples instead of buying expensive bottles blindly!"
                  </p>
              ...
              <Card className="card-elevated">
                <CardContent className="pt-4 lg:pt-6">
                  ...
                  <p className="text-xs sm:text-sm italic mb-3 lg:mb-4">
                    "The AI recommendations are spot on. It suggested fragrances I never would have considered but absolutely love."
                  </p>
                  <div className="text-xs text-muted-foreground">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 lg:gap-8">
            <div className="col-span-2 md:col-span-1 space-y-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="font-serif text-base sm:text-lg font-bold text-gradient-primary">ScentMatch</span>
              </div>
              <p className="text-xs sm:text-sm text-muted-foreground">
                AI-powered fragrance discovery platform helping you find your perfect scent.
              </p>
            </div>
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <nav className="space-y-2 text-xs sm:text-sm">
                ...
                <Link href="/samples" className="text-muted-foreground hover:text-foreground transition-colors block">
                  Sample Sets
                </Link>
              </nav>
            </div>
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <nav className="space-y-2 text-xs sm:text-sm">
                <Link href="/how-it-works" className="text-muted-foreground hover:text-foreground transition-colors block">
                  How It Works
                </Link>
                <Link href="/about" className="text-muted-foreground hover:text-foreground transition-colors block">
                  About Us
                </Link>
                <Link href="/blog" className="text-muted-foreground hover:text-foreground transition-colors block">
                  Fragrance Guide
                </Link>
              </nav>
            </div>
            ...
            <div className="space-y-3 lg:space-y-4">
              ...
              <nav className="space-y-2 text-xs sm:text-sm">
                <Link href="/auth/signup" className="text-muted-foreground hover:text-foreground transition-colors block">
                  Sign Up
                </Link>
                <Link href="/auth/login" className="text-muted-foreground hover:text-foreground transition-colors block">
                  Sign In
                </Link>
                <Link href="/dashboard" className="text-muted-foreground hover:text-foreground transition-colors block">
                  My Collection
                </Link>
              </nav>
            </div>
