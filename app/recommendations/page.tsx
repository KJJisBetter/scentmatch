...
export const metadata: Metadata = {
  ...
  description: 'Discover your next favorite fragrance with AI-powered personalized recommendations tailored to your unique taste.',
  keywords: 'fragrance recommendations, AI perfume discovery, personalized scents, fragrance matching, scent recommendations',
  openGraph: {
    title: 'AI-Powered Fragrance Recommendations - ScentMatch',
    description: 'Discover fragrances perfectly matched to your taste with our advanced AI recommendation engine.',
    type: 'website',
    images: [
      {
...
async function getUserRecommendationData() {
  ...
  try {
    ...
    const { data: initialRecommendations, error: recError } = await supabase.rpc('get_personalized_recommendations', {
      target_user_id: user.id,
      max_results: 20,
      include_owned: false
    });
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Discover fragrances perfectly matched to your taste using our advanced AI recommendation engine
          </p>
          ...
          <div className="flex items-center justify-center space-x-8 mt-6 text-sm text-muted-foreground">
            <div className="flex items-center space-x-2">
              ...
              <span>AI Confidence: {Math.round((collectionStats.diversity_score || 0.5) * 100)}%</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-blue-500 rounded-full" />
              <span>Collection: {collectionStats.total_fragrances || 0} fragrances</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-purple-500 rounded-full" />
              <span>Learning from {recentInteractions.length} recent interactions</span>
            </div>
          </div>
        </div>
        ...
        {(!collectionStats || collectionStats.total_fragrances === 0) && (
          <div className="mb-12 p-8 bg-gradient-to-r from-amber-100 to-orange-100 rounded-xl text-center">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Let us help you discover your signature scent. Our AI will learn your preferences as you explore.
            </p>
        ...
        <Suspense fallback={<RecommendationsSystemSkeleton />}>
        ...
        <div className="mt-16 p-6 bg-card rounded-xl border">
          <div className="text-center">
            <h3 className="text-lg font-semibold mb-4">How Our AI Recommendations Work</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-muted-foreground">
              <div>
                <div className="text-2xl mb-2">🧠</div>
                <h4 className="font-medium text-foreground mb-2">Advanced AI Analysis</h4>
                <p>Our hybrid algorithm analyzes scent profiles, your collection, and preferences from thousands of fragrance enthusiasts.</p>
              </div>
              <div>
                <div className="text-2xl mb-2">🔒</div>
                <h4 className="font-medium text-foreground mb-2">Privacy First</h4>
                <p>Your data stays private. You control what we learn and can adjust or reset preferences anytime.</p>
              </div>
              <div>
                <div className="text-2xl mb-2">📈</div>
                <h4 className="font-medium text-foreground mb-2">Gets Better Over Time</h4>
                <p>Every interaction improves our understanding of your taste. The more you use ScentMatch, the better your recommendations become.</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="p-6 bg-card rounded-xl border">
        <div className="h-6 bg-muted animate-pulse rounded mb-4" style={{ width: '200px' }} />
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="space-y-2">
              <div className="h-4 bg-muted animate-pulse rounded" style={{ width: '120px' }} />
      ...
      {['Perfect Matches', 'Trending in Your Style', 'Adventurous Picks', 'Seasonal Favorites'].map((sectionTitle) => (
        <div key={sectionTitle} className="space-y-6">
          <div className="h-8 bg-muted animate-pulse rounded" style={{ width: '250px' }} />
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {Array.from({ length: 4 }).map((_, i) => (
              <div key={i} className="bg-card rounded-xl border p-6">
                <div className="aspect-square bg-muted animate-pulse rounded-lg mb-4" />
                <div className="space-y-2">
                  <div className="h-5 bg-muted animate-pulse rounded" style={{ width: '80%' }} />
