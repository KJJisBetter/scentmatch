...
export const metadata: Metadata = {
  ...
  description:
    'Take our 3-minute quiz to discover your fragrance personality and get personalized scent recommendations.',
  keywords:
    'fragrance quiz, personality test, scent matching, perfume finder, fragrance recommendations',
  openGraph: {
    title: 'Find Your Perfect Fragrance in 3 Minutes',
    description:
      'Discover your fragrance personality and get personalized recommendations tailored just for you.',
    type: 'website',
    images: [
      {
        url: '/og-quiz.jpg',
        ...
        <div className='mt-12 text-center'>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-muted-foreground'>
            <div>
              ...
              <p>
                Our quiz analyzes your style to find fragrances you'll actually
                love
              </p>
            </div>
            <div>
