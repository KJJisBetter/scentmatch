...
export function ConversionFlow({
  ...
  const [step, setStep] = useState<'quiz_results' | 'account_form' | 'conversion_success' | 'guest_limitations'>('quiz_results');
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-pink-50">
          <CardContent className="text-center py-8">
            ...
            <Badge variant="accent" className="text-lg px-6 py-2 mb-4">
              {personalityDisplayNames[quizResults.personality_type as keyof typeof personalityDisplayNames]}
            </Badge>
        ...
        <div>
          <h3 className="text-2xl font-bold text-center mb-6">Your Top 3 Matches</h3>
            ...
            {quizResults.recommendations.slice(0, 3).map((rec, index) => (
              <Card key={rec.fragrance_id} className="relative">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">{rec.brand}</p>
            ...
            <CardContent className="text-center py-8">
              <div className="relative">
                ...
                <p className="text-lg text-purple-700 mb-6">
                  Create your free account to see all your personalized recommendations
                </p>
                  ...
                  <Button 
                    ...
                    onClick={() => {
                      ...
                      if (typeof window !== 'undefined' && (window as any).gtag) {
                        (window as any).gtag('event', 'account_creation_started', {
        ...
        <Card>
          <CardContent className="py-8">
            <div className="text-center mb-6">
              <h2 className="text-2xl font-bold mb-2">Create Your ScentMatch Account</h2>
              <p className="text-muted-foreground">Unlock all your personalized matches</p>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 p-3 rounded-lg mb-6">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-green-800">
                  Your {quizResults.personality_type} personality and quiz results will be saved
                </span>
              </div>
            </div>
            ...
            {errors.length > 0 && (
              <div className="bg-red-50 border border-red-200 p-3 rounded-lg mb-4">
                {errors.map(error => (
                  <div key={error} className="text-sm text-red-800">{error}</div>
                ))}
              </div>
            )}
            ...
            <div className="space-y-4">
              ...
              <Button
                ...
                disabled={isCreatingAccount || !accountData.email || !accountData.password || !accountData.firstName}
        ...
        <Card className="bg-gradient-to-br from-green-50 to-blue-50">
          <CardContent className="py-8">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Your account is ready and your {quizResults.personality_type} personality has been saved
            </p>

            {/* Immediate Benefits Display */}
            <div className="bg-white p-6 rounded-lg border border-green-200 mb-6">
              <h3 className="font-bold mb-4 text-green-800">Account Created Successfully!</h3>
            ...
            <div className="space-y-4">
              <Button 
                ...
                onClick={() => router.push('/recommendations?quiz_completed=true')}
              >
          ...
          <CardContent className="py-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">See all 15 matches based on your {quizResults.personality_type} style</p>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">2️⃣</div>
                <h4 className="font-medium">Order Samples</h4>
                <p className="text-muted-foreground">Try 2-3 samples risk-free with your discount</p>
              </div>
              <div className="text-center">
                <div className="text-2xl mb-2">3️⃣</div>
                <h4 className="font-medium">Build Collection</h4>
                <p className="text-muted-foreground">Save favorites and track your fragrance journey</p>
              </div>
            </div>
          </CardContent>
        </Card>
  ...
  if (step === 'guest_limitations') {
    return (
      <div className="max-w-2xl mx-auto">
        <Card>
          <CardContent className="py-8">
            <h3 className="text-xl font-bold mb-6 text-center">Continuing as Guest</h3>
            
            {/* What They're Missing */}
            <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg mb-6">
              <h4 className="font-medium text-yellow-800 mb-3">Limited Guest Experience:</h4>
              <div className="space-y-2 text-sm text-yellow-700">
                <div>⚠️ Only 3 recommendations (missing 12 perfect matches)</div>
                <div>⚠️ Cannot save favorites or build collection</div>
                <div>⚠️ No enhanced AI recommendations based on your activity</div>
            ...
            <div className="text-center space-y-4">
              <p className="text-muted-foreground mb-4">
                Most {quizResults.personality_type} users create accounts to unlock their full matches
              </p>
