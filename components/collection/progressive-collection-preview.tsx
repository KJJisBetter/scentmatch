...
export function ProgressiveCollectionPreview({
  ...
  return (
    ...
    >
      ...
      <div className='text-center space-y-4 animate-slide-in-from-top'>
        <div className='space-y-2'>
          ...
          <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
            Based on your preferences, we've found {recommendations.length}{' '}
            fragrances that are perfect for you. Save them to your collection to
            never lose track!
          </p>
        </div>
        ...
        {socialProofData && (
          <div
            className='flex items-center justify-center space-x-6 text-sm text-muted-foreground animate-fade-in'
          ...
          >
            ...
            <div className='flex items-center space-x-2'>
              ...
              <span>
                {socialProofData.collections_created_today} collections today
              </span>
            </div>
          </div>
        )}
      ...
      {/* Collection Stats */}
      <div
        className='grid grid-cols-1 md:grid-cols-3 gap-4 animate-slide-in-from-bottom'
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {Math.round(
                recommendations.reduce((acc, r) => acc + r.match_score, 0) /
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
        {recommendations.map((recommendation, index) => (
          <ProgressiveRecommendationCard
            ...
            index={index}
            isSelected={selectedFragrances.includes(
              recommendation.fragrance.id
            )}
            onToggleSelection={() =>
              toggleFragranceSelection(recommendation.fragrance.id)
            }
          />
        ))}
      </div>
      ...
      {/* Action Buttons */}
      <div
        className='flex flex-col sm:flex-row items-center justify-center space-y-3 sm:space-y-0 sm:space-x-4 animate-slide-in-from-bottom'
      ...
      {/* Benefits Section */}
      <div
        className='bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-6 animate-fade-in'
        style={{ animationDelay: '0.4s' }}
      >
        <h3 className='text-lg font-semibold mb-4 text-center'>
          Why Save Your Collection?
        </h3>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm'>
          <div className='text-center'>
            ...
            <p className='text-muted-foreground'>
              Keep your perfect fragrances safe and accessible anytime
            </p>
          </div>
          <div className='text-center'>
            <div className='text-2xl mb-2'>📊</div>
            ...
            <p className='text-muted-foreground'>
              Rate, review, and organize your fragrance experiences
            </p>
          </div>
          <div className='text-center'>
            <div className='text-2xl mb-2'>🎁</div>
            ...
            <p className='text-muted-foreground'>
              Receive recommendations and deals based on your preferences
            </p>
          </div>
        </div>
      </div>
