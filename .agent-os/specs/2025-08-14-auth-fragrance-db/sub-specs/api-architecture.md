...
export async function addToCollection(formData: FormData) {
  ...
  const validatedFields = AddToCollectionSchema.safeParse({
    ...
    bottleSize: formData.get('bottleSize')
      ? Number(formData.get('bottleSize'))
      : undefined,
  ...
  const { error } = await supabase.from('user_fragrances').upsert({
...
export async function createReview(formData: FormData) {
  ...
  const validatedFields = ReviewSchema.safeParse({
    ...
    longevityRating: formData.get('longevityRating')
      ? Number(formData.get('longevityRating'))
      : undefined,
    sillageRating: formData.get('sillageRating')
      ? Number(formData.get('sillageRating'))
      : undefined,
    valueRating: formData.get('valueRating')
      ? Number(formData.get('valueRating'))
      : undefined,
  });
